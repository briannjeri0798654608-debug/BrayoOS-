...
APPS = [
    ...
    ("🤖", "Auto AIRA", "aira_autonomous.py", "#CC44FF"),
    ("🕷️", "Dark Browser", "dark_web_browser.py", "#FF0044"),
    ("💀", "Hacker RPG", "hacker_rpg.py", "#00FF41"),
    ("☁️", "Cloud", "brayos_cloud.py", "#44FFFF"),
    ("📶", "WiFi Pass", "wifi_passwords.py", "#44AAFF"),
    ("🎯", "IP Grabber", "ip_grabber.py", "#FF0044"),
    ("🔑", "Pass Mgr", "password_manager.py", "#FFD700"),
    ("🔐", "File Encrypt", "file_encryptor.py", "#44FFFF"),
    ("🧠", "Habits", "habit_learner.py", "#CC44FF"),
    ("🔮", "Quantum Vault", "quantum_vault.py", "#44FFFF"),
    ("🌍", "World Map", "world_map.py", "#FF0044"),
    ("📱", "Phone Ctrl", "phone_controller.py", "#CC44FF"),
    ("📰", "AI News", "ai_news.py", "#FF8844"),
