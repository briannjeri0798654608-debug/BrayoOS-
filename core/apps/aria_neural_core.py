...
MEMORY_FILE = os.path.expanduser("~/BrayoOS/memory/aria_neural.json")
os.makedirs(os.path.dirname(MEMORY_FILE), exist_ok=True)

class ARIANeuralCore:
    def __init__(self, root):
        self.root = root
        self.root.title("🧠 ARIA Neural Core")
    ...
    def build_ui(self):
        tk.Label(self.root, text="🧠 ARIA NEURAL CORE", font=("Courier", 18, "bold"),
        ...
        tk.Label(self.root, text="◈ ARIA THOUGHT STREAM", font=("Courier", 10, "bold"),
        ...
        tk.Label(self.root, text="◈ ARIA PREDICTS YOUR NEXT MOVE", font=("Courier", 10, "bold"),
        ...
        for text, cmd in [
            ("🧠 TRAIN ARIA", self.train), ("📊 SHOW PATTERNS", self.show_patterns),
        ...
        tk.Label(self.root, text="BrayoOS Neural Engine v1.0 • Brayo & ARIA 🇰🇪",
    ...
    def learn_loop(self):
        thoughts = [
            ...
            "ARIA learning complete. Adapting..."
        ]
        predictions = [
            ...
            "ARIA suggests: backup your files now",
    ...
    def reset_memory(self):
        ...
        self.save_memory()
        self.log("🗑️ Neural memory wiped. ARIA reborn from zero.")
